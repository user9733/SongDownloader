 ...
 * </table>
 * <p class="beaglebuddy">
 * An <i>audio encryption</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.mp3.enums.FrameType#AUDIO_ENCRYPTION AENC} {@link com.beaglebuddy.mp3.id3v23.ID3v23Frame frame} which is used to indicate if any part, or all, of the actual audio
 ...
 * </p>
 * <p class="beaglebuddy">
 * There may be more than one audio encryption frame in an ID3v2.3 {@link com.beaglebuddy.mp3.id3v23.ID3v23Tag tag}, but only one with the same <i>ownerId</i> field.
 * </p>
