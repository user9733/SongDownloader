 ...
 * </table>
 * <p class="beaglebuddy">
 * An <i>unsynchronized lyrics</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.mp3.enums.FrameType#UNSYCHRONIZED_LYRICS USLT} {@link com.beaglebuddy.mp3.id3v23.ID3v23Frame frame} which is used to include the lyrics
 ...
 *    </thead>
 *    <tbody>
 *       <tr><td class="beaglebuddy">1. </td><td class="beaglebuddy">{@link com.beaglebuddy.mp3.enums.Encoding encoding}</td><td class="beaglebuddy">character set used to {@link #setEncoding(Encoding) encode} the <i>description</i> and <i>text</i> fields.</td></tr>
 *       <tr><td class="beaglebuddy">2. </td><td class="beaglebuddy">{@link com.beaglebuddy.mp3.enums.Language language}</td><td class="beaglebuddy">language that the <i>text</i> field is written in.                                                        </td></tr>
 ...
 * </p>
 * <p class="beaglebuddy">
 * There may be more than one <i>unsynchronized lyrics</i> frame in an ID3v2.3 {@link com.beaglebuddy.mp3.id3v23.ID3v23Tag tag}, but only one with the same
...
public class ID3v23FrameBodyUnsynchronizedLyrics extends ID3v23FrameBody
{
    ...
    * @param language      ISO-639-2 {@link com.beaglebuddy.mp3.enums.Language} code the lryics are written in.
   ...
   /**
    * gets the {@link com.beaglebuddy.mp3.enums.Language language} the unsynchronized lyrics are written in.
    * @return the {@link com.beaglebuddy.mp3.enums.Language language} the unsynchronized lyrics are written in.
   ...
   /**
    * sets the {@link com.beaglebuddy.mp3.enums.Language language} the unsynchronized lyrics are written in.
    * @param language   {@link com.beaglebuddy.mp3.enums.Language language} the unsynchronized lyrics are written in.
    * @see #getLanguage()
    */
