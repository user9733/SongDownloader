 ...
 * </table>
 * <p class="beaglebuddy">
 * A <i>user defined text information</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.mp3.enums.FrameType#USER_DEFINED_TEXT_INFORMATION TXXX} {@link com.beaglebuddy.mp3.id3v23.ID3v23Frame frame} which is used to include one-string text
 ...
 * </table>
 * <p class="beaglebuddy">
 * There may be more than one <i>user defined text information</i> frame in an ID3v2.3 {@link com.beaglebuddy.mp3.id3v23.ID3v23Tag tag}, but only one with the same <i>description</i> field.
 * </p>
...
public class ID3v23FrameBodyUserDefinedTextInformation extends ID3v23FrameBody
{
    ...
    * @param encoding    the character set used to encode the description and the text..  Only ISO 8859-1 and UTF-16 are allowed.
    * @see #getEncoding()
    */
