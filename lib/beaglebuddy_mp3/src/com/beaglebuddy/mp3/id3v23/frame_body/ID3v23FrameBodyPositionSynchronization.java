 ...
 * </table>
 * <p class="beaglebuddy">
 * An <i>position synchronization</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.mp3.enums.FrameType#POSITION_SYNCHRONIZATION POSS} {@link com.beaglebuddy.mp3.id3v23.ID3v23Frame frame} which is used to
 ...
 *    </thead>
 *    <tbody>
 *       <tr><td class="beaglebuddy">1. </td><td class="beaglebuddy">{@link com.beaglebuddy.mp3.enums.TimeStampFormat time stamp format}</td><td class="beaglebuddy">{@link #setTimeStampFormat(TimeStampFormat) units} of the <i>position</i> field.</td></tr>
