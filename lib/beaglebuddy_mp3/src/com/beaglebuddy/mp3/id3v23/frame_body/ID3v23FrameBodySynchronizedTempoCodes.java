 ...
 * </table>
 * <p class="beaglebuddy">
 * A <i>synchronized tempo codes</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.mp3.enums.FrameType#SYNCHRONIZED_TEMPO_CODES <i>SYTC</i>} {@link com.beaglebuddy.mp3.id3v23.ID3v23Frame frame} which is used to specify tempo changes in the .mp3 song.
 ...
 *    </thead>
 *    <tbody>
 *       <tr><td class="beaglebuddy">1. </td><td class="beaglebuddy">{@link com.beaglebuddy.mp3.enums.TimeStampFormat time stamp format}</td><td class="beaglebuddy">{@link #setTimeStampFormat(TimeStampFormat) units} of the <i>time stamp</i> field in the {@link TempoChange tempo changes}.</td></tr>
 ...
 * </p>
 * <p class="beaglebuddy">
 * There may be only one <i>synchronized tempo codes</i> frame in an ID3v2.3 {@link com.beaglebuddy.mp3.id3v23.ID3v23Tag tag}.
 * </p>
...
public class ID3v23FrameBodySynchronizedTempoCodes extends ID3v23FrameBody
{
   ...
   public class TempoChange
   {
       ...
       * @param timeStamp        the timestamp in the song where the tempo change occurs.  The units of the timestamp are specified by the {@link com.beaglebuddy.mp3.enums.TimeStampFormat time stamp format} field.
       */
