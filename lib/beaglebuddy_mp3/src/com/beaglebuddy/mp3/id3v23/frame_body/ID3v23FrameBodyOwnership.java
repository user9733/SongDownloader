 ...
 * </table>
 * <p class="beaglebuddy">
 * An <i>ownership</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.mp3.enums.FrameType#OWNERSHIP OWNE} {@link com.beaglebuddy.mp3.id3v23.ID3v23Frame frame} which is used to indicate that a user is the owner of the
 ...
 *    </thead>
 *    <tbody>
 *       <tr><td class="beaglebuddy">1. </td><td class="beaglebuddy">{@link com.beaglebuddy.mp3.enums.Encoding encoding}</td><td class="beaglebuddy">character set used to {@link #setEncoding(Encoding) encode} the <i>seller</i> field.                                                                     </td></tr>
...
public class ID3v23FrameBodyOwnership extends ID3v23FrameBody
{
   ...
   public void setBuffer()
   {
      if (isDirty())
      {
         ...
         byte[] purchaseDateBytes = stringToBytes(Encoding.ISO_8859_1.getCharacterSet(), purchaseDate);
