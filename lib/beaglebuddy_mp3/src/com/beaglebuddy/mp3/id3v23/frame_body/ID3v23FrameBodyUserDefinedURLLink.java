 ...
 * </table>
 * <p class="beaglebuddy">
 * A <i>user defined url link</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.mp3.enums.FrameType#USER_DEFINED_URL_LINK_FRAME WXXX} {@link com.beaglebuddy.mp3.id3v23.ID3v23Frame frame} which is used to include URL links concerning the
 ...
 * </p>
 * <p class="beaglebuddy">
 * There may be more than one <i>user defined url link</i> frame in an ID3v2.3 {@link com.beaglebuddy.mp3.id3v23.ID3v23Tag tag}, but only one with the same <i>description</i> field.
 * </p>
...
public class ID3v23FrameBodyUserDefinedURLLink extends ID3v23FrameBody
{
    ...
    * @param file           input stream pointing to a user defined url link frame body in the .mp3 file.
    ...
    */
   public ID3v23FrameBodyUserDefinedURLLink(InputStream file, int frameBodySize) throws IOException
   {
      super(file, FrameType.USER_DEFINED_URL_LINK_FRAME, frameBodySize);
   }
   ...
   public void parse() throws IllegalArgumentException
   {
      ...
      nullTerminatorIndex  = getNextNullTerminator(1, encoding.getCharacterSet());
