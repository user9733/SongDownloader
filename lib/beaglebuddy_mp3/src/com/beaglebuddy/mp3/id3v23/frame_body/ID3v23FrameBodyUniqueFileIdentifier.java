 ...
 * </table>
 * <p class="beaglebuddy">
 * A <i>unique file identifier</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.mp3.enums.FrameType#UNIQUE_FILE_IDENTIFIER UFID} {@link com.beaglebuddy.mp3.id3v23.ID3v23Frame frame} which is used to identify the audio file in a
 ...
 * </p>
 * <p class="beaglebuddy">
 * There may be more than one <i>unique file identifier</i> frame in an ID3v2.3 {@link com.beaglebuddy.mp3.id3v23.ID3v23Tag tag}, but only one with the same <i>owner id</i> field.
 * </p>
