 ...
 * </table>
 * <p class="beaglebuddy">
 * An <i>group identification registration</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.mp3.enums.FrameType#GROUP_IDENTIFICATION_REGISTRATION GRID} {@link com.beaglebuddy.mp3.id3v23.ID3v23Frame frame} which is used to group otherwise unrelated frames.
 ...
 * </p>
 * <p class="beaglebuddy">
 * There may be more than one <i>group identification registration</i> frame in an ID3v2.3 {@link com.beaglebuddy.mp3.id3v23.ID3v23Tag tag}, but only one containing the same
...
public class ID3v23FrameBodyGroupIdentificationRegistration extends ID3v23FrameBody
{
   ...
   {
      nullTerminatorIndex = getNextNullTerminator(0, Encoding.ISO_8859_1.getCharacterSet());
   ...
   public void setBuffer()
   {
      if (isDirty())
      {
         byte[] ownerIdBytes = stringToBytes(Encoding.ISO_8859_1.getCharacterSet(), ownerId);
         int    index        = 0;
