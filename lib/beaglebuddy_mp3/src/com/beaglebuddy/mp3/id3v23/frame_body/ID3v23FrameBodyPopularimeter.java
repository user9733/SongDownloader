 ...
 * </table>
 * <p class="beaglebuddy">
 * A <i>popularimeter</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.mp3.enums.FrameType#POPULARIMETER POPM} {@link com.beaglebuddy.mp3.id3v23.ID3v23Frame frame} which is used to specify how much you like an .mp3 song.
...
public class ID3v23FrameBodyPopularimeter extends ID3v23FrameBody
{
   ...
   public void parse() throws IllegalArgumentException
   {
      ...
      if ((nullTerminatorIndex + 4) <= buffer.length)
      {
         ...
         {
            throw new IllegalArgumentException("We need to add code here to support this very unlikely event.");
         }
      }
   ...
   public void setBuffer()
   {
      if (isDirty())
      {
         byte[] userEmailBytes = stringToBytes(Encoding.ISO_8859_1.getCharacterSet(), userEmail);
