 ...
 * </table>
 * <p class="beaglebuddy">
 * An <i>equalization</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.mp3.enums.FrameType#EQUALIZATION EQUA} {@link com.beaglebuddy.mp3.id3v23.ID3v23Frame frame} which is used to specify points on an equalization (EQ)
 ...
 *       <tr><td class="beaglebuddy">2. </td><td class="beaglebuddy">{@link com.beaglebuddy.mp3.pojo.Level levels}</td><td class="beaglebuddy">list of the points on the EQ curve                                                      </td></tr>
 *    </tbody>
 * </table>
 * </p>
 * <p class="beaglebuddy">
 * There may be only one <i>equalization</i> frame in an ID3v2.3 {@link com.beaglebuddy.mp3.id3v23.ID3v23Tag tag}.
 * </p>
