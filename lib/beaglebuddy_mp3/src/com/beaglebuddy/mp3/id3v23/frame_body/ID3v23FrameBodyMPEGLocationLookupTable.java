 ...
 * </table>
 * <p class="beaglebuddy">
 * An <i>MPEG location lookup table</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.mp3.enums.FrameType#MPEG_LOCATION_LOOKUP_TABLE MLLT} {@link com.beaglebuddy.mp3.id3v23.ID3v23Frame frame} which is used to ncrease performance and accuracy of jumps within an MPEG audio file.
