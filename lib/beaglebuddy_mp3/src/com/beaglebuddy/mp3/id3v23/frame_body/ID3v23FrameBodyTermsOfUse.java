 ...
 * </table>
 * <p class="beaglebuddy">
 * A <i>terms of use</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.mp3.enums.FrameType#TERMS_OF_USE USER} {@link com.beaglebuddy.mp3.id3v23.ID3v23Frame frame} which is used to include a brief description of the
 ...
 *    </thead>
 *    <tbody>
 *       <tr><td class="beaglebuddy">1. </td><td class="beaglebuddy">{@link com.beaglebuddy.mp3.enums.Encoding encoding}</td><td class="beaglebuddy">character set used to {@link #setEncoding(Encoding) encode} the <i>text</i> field.</td></tr>
 ...
 * </p>
 * <p class="beaglebuddy">
 * There may only be one <i>terms of use</i> frame in an {@link com.beaglebuddy.mp3.id3v23.ID3v23Tag ID3v2.3 tag}.
 * </p>
...
public class ID3v23FrameBodyTermsOfUse extends ID3v23FrameBody
{
   ...
   /**
    * gets the {@link com.beaglebuddy.mp3.enums.Language language} the terms of user are written in.
    * @return the {@link com.beaglebuddy.mp3.enums.Language language} the terms of user are written in.
   ...
   /**
    * sets the {@link com.beaglebuddy.mp3.enums.Language language} the terms of user are written in.
    * @param language   {@link com.beaglebuddy.mp3.enums.Language language} the terms of user are written in.
    * @see #getLanguage()
    */
