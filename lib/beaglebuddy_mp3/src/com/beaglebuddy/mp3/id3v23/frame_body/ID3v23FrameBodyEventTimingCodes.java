...
import com.beaglebuddy.mp3.pojo.EventCode;
 ...
 * </table>
 * <p class="beaglebuddy">
 * An <i>event timing codes</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.mp3.enums.FrameType#EVENT_TIMING_CODES ETCO} {@link com.beaglebuddy.mp3.id3v23.ID3v23Frame frame} which is used to synchronize key events in a song.
 ...
 *    </thead>
 *    <tbody>
 *       <tr><td class="beaglebuddy">1.</td><td class="beaglebuddy">{@link com.beaglebuddy.mp3.enums.TimeStampFormat time stamp format}</td><td class="beaglebuddy">{@link #setTimeStampFormat(TimeStampFormat) units} of the <i>time stamp</i> field in the {@link com.beaglebuddy.mp3.pojo.EventCode event codes} field.</td></tr>
 *       <tr><td class="beaglebuddy">2.</td><td class="beaglebuddy">eventCodes                                                         </td><td class="beaglebuddy">list of {@link com.beaglebuddy.mp3.pojo.EventCode events}.                                                                                            </td></tr>
 *    </tbody>
 * </table>
 * <p class="beaglebuddy">
 * There may be only one <i>event timing codes</i> frame in an ID3v2.3 {@link com.beaglebuddy.mp3.id3v23.ID3v23Tag tag}.
 * </p>
...
public class ID3v23FrameBodyEventTimingCodes extends ID3v23FrameBody
{
   ...
   public void parse() throws IllegalArgumentException
   {
      try
      {
         setTimeStampFormat(TimeStampFormat.getTimeStampFormat(buffer[0]));
      }
      ...
      {
         EventType eventType = EventType.getEventType(buffer[index]);
