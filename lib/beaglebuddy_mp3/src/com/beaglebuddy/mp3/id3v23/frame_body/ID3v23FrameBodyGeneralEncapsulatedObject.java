 ...
 * </table>
 * <p class="beaglebuddy">
 * A <i>general encapsulated object</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.mp3.enums.FrameType#GENERAL_ENCAPSULATED_OBJECT GEOB} {@link com.beaglebuddy.mp3.id3v23.ID3v23Frame frame} which is used to embed a file in the .mp3 file.
 * The file may be of any type.  This is a generalization of the {@link com.beaglebuddy.mp3.id3v23.frame_body.ID3v23FrameBodyAttachedPicture attached picture} frame which only allows image
 ...
 *    </thead>
 *    <tbody>
 *       <tr><td class="beaglebuddy">1. </td><td class="beaglebuddy">{@link com.beaglebuddy.mp3.enums.Encoding encoding}                          </td><td class="beaglebuddy">character set used to {@link #setEncoding(Encoding) encode} the <i>filename</i> and <i>description</i> fields.   </td></tr>
 ...
 * </p>
 * <p class="beaglebuddy">
 * There may be more than one <i>general encapsulated object</i> frame in an ID3v2.3 {@link com.beaglebuddy.mp3.id3v23.ID3v23Tag tag}, but only one with the same
...
public class ID3v23FrameBodyGeneralEncapsulatedObject extends ID3v23FrameBody
{
   ...
   public void setBuffer()
   {
      if (isDirty())
      {
         ...
         byte[]  filenameBytes    = stringToBytes(encoding.getCharacterSet()           , filename   );
