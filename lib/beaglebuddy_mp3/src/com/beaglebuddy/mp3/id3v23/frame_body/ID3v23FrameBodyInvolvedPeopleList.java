 ...
 * </table>
 * <p class="beaglebuddy">
 * An <i>involved people list</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.mp3.enums.FrameType#INVOLVED_PEOPLE_LIST IPLS} {@link com.beaglebuddy.mp3.id3v23.ID3v23Frame frame} which is used to list the people who were involved
 ...
 *    </thead>
 *    <tbody>
 *       <tr><td class="beaglebuddy">1. </td><td class="beaglebuddy">{@link com.beaglebuddy.mp3.enums.Encoding encoding}</td><td class="beaglebuddy">character set used to {@link #setEncoding(Encoding) encode} the <i>involved people</i> field.</td></tr>
 ...
 * </p>
 * <p class="beaglebuddy">
 * There may only be one <i>involved people list</i> frame in an ID3v2.3 {@link com.beaglebuddy.mp3.id3v23.ID3v23Tag tag}.
 * </p>
...
public class ID3v23FrameBodyInvolvedPeopleList extends ID3v23FrameBody
{
   ...
   public void setBuffer()
   {
      if (isDirty())
      {
         ...
         {
            length += stringToBytes(encoding.getCharacterSet(), involvedPerson.getInvolvement()).length;
            length += stringToBytes(encoding.getCharacterSet(), involvedPerson.getPerson     ()).length;
         }
         ...
         for(InvolvedPerson involvedPerson : involvedPeople)
         {
            byte[] involvementBytes = stringToBytes(encoding.getCharacterSet(), involvedPerson.getInvolvement());
            byte[] personBytes      = stringToBytes(encoding.getCharacterSet(), involvedPerson.getPerson     ());
