 ...
 * </table>
 * <p class="beaglebuddy">
 * An <i>encryption method registration</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.mp3.enums.FrameType#ENCRYPTION_METHOD_REGISTRATION ENCR} {@link com.beaglebuddy.mp3.id3v23.ID3v23Frame frame} which is used to identify with which method a frame
 ...
 * </p>
 * <p>
 * There may be more than one <i>encrypted method registration</i> frame in an ID3v2.3 {@link com.beaglebuddy.mp3.id3v23.ID3v23Tag tag}, but only one with the same method
