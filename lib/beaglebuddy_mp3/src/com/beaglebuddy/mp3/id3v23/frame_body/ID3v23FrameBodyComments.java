 ...
 * </table>
 * <p class="beaglebuddy">
 * A <i>comments</i> frame body is associated with an ID3v2.3 {@link com.beaglebuddy.mp3.enums.FrameType#COMMENTS COMM} {@link com.beaglebuddy.mp3.id3v23.ID3v23Frame frame} which is intended for any kind of full text information that does not fit
 ...
 *       <tr><td class="beaglebuddy">2.</td><td class="beaglebuddy">{@link com.beaglebuddy.mp3.enums.Language language}</td><td class="beaglebuddy">{@link #setLanguage(Language) language} the comments are written in.                                      </td></tr>
 ...
 * </table>
 * <p class="beaglebuddy">
 * There may be more than one <i>comment</i> frame in an ID3v2.3 {@link com.beaglebuddy.mp3.id3v23.ID3v23Tag tag}, but only one with the same <i>language</i> and
...
public class ID3v23FrameBodyComments extends ID3v23FrameBody
{
   ...
   /**
    * gets the {@link com.beaglebuddy.mp3.enums.Language language} the comments are written in.
   ...
   /**
    * sets the {@link com.beaglebuddy.mp3.enums.Language language} the comments are written in.
    * @param language   {@link com.beaglebuddy.mp3.enums.Language language} the comments are written in.
    * @see #getLanguage()
    */
