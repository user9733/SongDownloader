 ...
 *    </tbody>
 * </table>
 * An event code is simply an event occurring at specified time.  There are 256 predefined {@link EventType types} of events in the ID3v2.3 specification.
 * <p class="beaglebuddy">
 ...
 *       <tr><td class="beaglebuddy">2. </td><td class="beaglebuddy">timeStamp                  </td><td class="beaglebuddy">when the event occurred.            </td></tr>
 *    </tbody>
 * </table>
 * </p>
 * <p class="beaglebuddy">
 ...
 * music to something, like setting of an explosion on-stage, or turning on your screensaver, etc.
 * </p>
 */
