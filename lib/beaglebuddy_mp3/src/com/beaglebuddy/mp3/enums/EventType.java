 ...
 * </table>
 * ID3v2.3 event types.
 * @see com.beaglebuddy.mp3.pojo.EventCode
 * @see com.beaglebuddy.mp3.id3v23.frame_body.ID3v23FrameBodyEventTimingCodes
 */
...
{                                                                                                                                                 /** padding (has no meaning)                                                                             */
    ...
    */
   public static EventType getEventType(byte eventType) throws IllegalArgumentException
   {
