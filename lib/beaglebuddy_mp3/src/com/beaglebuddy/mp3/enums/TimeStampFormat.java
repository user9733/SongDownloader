 ...
 *    </tbody>
 * </table>
 * ID3v2.3 time stamp units.
 * Many frames defined in the ID3v2.3 specification contain a timestamp field, indicating when something happened in the .mp3 song.
...
{                                                                        /** absolute time, 32 bit sized, using MPEG frames as units  */
   ...
   /**
    * converts an integral value to its corresponding time stamp format enum. 1 == MPEG frames, 2 = milliseconds
    ...
    */
   public static TimeStampFormat getTimeStampFormat(byte timeStampFormat) throws IllegalArgumentException
   {
